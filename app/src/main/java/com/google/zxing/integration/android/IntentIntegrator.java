...
public class IntentIntegrator
{
    ...
    public IntentIntegrator(Activity activity)
    {
        ...
        title = activity.getString(R.string.barscan_download_title);
        message = activity.getString(R.string.barscan_download_text);
        buttonYes = activity.getString(R.string.barscan_yes);
        buttonNo = activity.getString(R.string.barscan_no);
